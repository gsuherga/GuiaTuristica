...
public class HistoricoFragAlcazar extends Fragment {

    public HistoricoFragAlcazar() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.alcazar_historico_texto));
        ...
        fondo.setImageResource(R.drawable.alcazar03);
