...
public class TuristicoFragCatedral extends Fragment{

    public TuristicoFragCatedral() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.catedral_turistico_texto));
        ...
        fondo.setImageResource(R.drawable.catedral03);
