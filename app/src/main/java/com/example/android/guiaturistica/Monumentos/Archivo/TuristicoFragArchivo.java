...
public class TuristicoFragArchivo extends Fragment {

    public TuristicoFragArchivo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.archivo_turistico_texto));
        ...
        fondo.setImageResource(R.drawable.archivodeindias03);
