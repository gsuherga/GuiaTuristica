package com.example.android.guiaturistica.Monumentos.Archivo;
...
public class HistoricoFragArchivo extends Fragment {

    public HistoricoFragArchivo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.archivo_historico_texto));
        ...
        web.setText(R.string.archivo);
        web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String uri = getString(R.string.web_archivo);
                abrirWeb(uri);
            }
        });
        ...
        fondo.setImageResource(R.drawable.archivodeindias02);
