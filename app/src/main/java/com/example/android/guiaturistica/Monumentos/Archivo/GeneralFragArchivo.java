...
public class GeneralFragArchivo extends Fragment {

    public GeneralFragArchivo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.archivo_general_texto));
        ...
        fondo.setImageResource(R.drawable.archivodeindias01);
