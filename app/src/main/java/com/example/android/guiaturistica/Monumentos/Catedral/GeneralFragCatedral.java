...
public class GeneralFragCatedral extends Fragment {

    public GeneralFragCatedral() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.catedral_general_texto));
        ...
        fondo.setImageResource(R.drawable.catedral07);
        return rootView;
    }
