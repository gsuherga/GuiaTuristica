...
public class ArtisticoFragAlcazar extends Fragment {

    public ArtisticoFragAlcazar() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.alcazar_artistico_texto));
        ...
        fondo.setImageResource(R.drawable.alcazar04);
