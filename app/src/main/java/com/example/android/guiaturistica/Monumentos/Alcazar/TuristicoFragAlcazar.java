...
public class TuristicoFragAlcazar extends Fragment{

    public TuristicoFragAlcazar() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.alcazar_turistico_texto));
        ...
        fondo.setImageResource(R.drawable.alcazar02);
