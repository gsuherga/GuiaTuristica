...
public class ArtisticoFragArchivo extends Fragment {

    public ArtisticoFragArchivo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.archivo_artistico_texto));
        ...
        fondo.setImageResource(R.drawable.archivodeindias05);
