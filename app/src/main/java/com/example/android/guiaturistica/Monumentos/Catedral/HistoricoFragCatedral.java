...
public class HistoricoFragCatedral extends Fragment {

    public HistoricoFragCatedral() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        texto.setText(getResources().getString(R.string.catedral_historico_texto));
        ...
        //Obtner la imageview y disponer la imagen de fondo
        ImageView fondo = (ImageView) rootView.findViewById(R.id.fondo_fragmentos_monumentos);
        fondo.setImageResource(R.drawable.catedral09);
